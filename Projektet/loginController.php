		  	...
		  	if ($lh->IsLoggedIn()) {
				...
				if ($lw->RemoveUser()){
					...
					if ($lw->TriedToLogout()){
						...
						$xhtml .= $lw->DoLinks(); //All information som hör till xhtml här bör förflyttas till vyn.
						//Kalla här på $links = $lw-UploadFileLinks
						//Skapa en array. Skjut in links och $xhtml till den arrayen.
						//returnera den nyskapade arrayen.
						//Gör samma sak längst ner när du är inloggad. 
